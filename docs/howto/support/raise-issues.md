...
![Cleura Service Center portal](./assets/01-service-center-portal.png)
...
One of the key properties of a ticket is the **Issue Type**.
Broadly, we categorize issues into three backend categories: **Requests**, **Issues**, and **Managed Services**.
These categories are used internally to organize tickets but are not visible in the portal.
All request types are grouped together in the interface for simplicity.
...
- **Onboarding:**
    - Status Page (for compliant customers)
