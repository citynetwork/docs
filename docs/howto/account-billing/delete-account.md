...
Choose a reason for leaving and type in your current password. Click the red button named _Delete Account_ one more time. That will trigger a request for account deletion.
