...
The volume backup service is not yet configured in any of the {{brand}} regions.
As a result, volume backups created using the OpenStack CLI *cannot* be deleted.
